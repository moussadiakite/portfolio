...
const PortfolioPreview = () => {
  ...
  return (
    <div
      className="portfolio_tm_intro bg-image"
      style={{
    ...
    >
                ...
                {previewDemo.map((val) => (
                  ...
                  >
                    <div className="list_inner">
                      ...
                      <h3>{val.title}</h3>
                      <Link
                        className="portfolio_tm_full_link"
                        href={val.routerPath}
                        target="_blank"
                        rel="noreferrer"
                      ></Link>
      ...
      <div className="go_purchase">
        ...
        <h3 data-aos="fade-up" data-aos-duration="1200" data-aos-delay="100">
          Purchase Portfolio and Build Your Super Fast{" "}
          <span className="theme-color">React Next JS</span> Portfolio Template.
        </h3>
        <div
          className="portfolio_tm_button intro"
          data-aos="fade-up"
          data-aos-duration="1200"
          data-aos-delay="200"
        >
          <a
            href="https://themeforest.net/item/portfolio-personal-portfolio-react-template/34082686"
            target="_blank"
            rel="noreferrer"
          >
            Purchase Now
